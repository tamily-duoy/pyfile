...
from spiderSmooc import conf
from spiderSmooc.conf import COURSEURL, CHOOSE

# from filedeal import file_downloader
from  spiderSmooc.filedeal import file_downloader
from spiderSmooc.spider import html_parser
from spiderSmooc.spider import html_downloader
...
class SpiderMan(object):
    ...
    def cmdshow_gbk(self):
        ...
        try:
            ...
            ID = input(u'输入要下载的课程编号：'.decode('utf-8').encode('gbk'))
            # ID = input('输入要下载的课程编号：'.encode('gbk'))
